...
public class BloqueoPersonaControlador {
    ...
    private void volverAlDashboard() {
        try {
            ...
            Scene escena = new Scene(raiz); escena.getStylesheets().add(getClass().getResource("/css/application.css").toExternalForm());
            Stage stage = (Stage) botonVolver.getScene().getWindow(); stage.setScene(escena); stage.setTitle("SICA - Dashboard"); stage.setResizable(true); stage.show();
